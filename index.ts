export { default as Astronav } from "./src/Navbar.astro";
...
export { default as CloseIcon } from "./src/components/CloseIcon.astro";
export { default as MenuItems } from "./src/components/MenuItems.astro";
